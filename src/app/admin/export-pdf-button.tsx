...
export default function ExportPDFButton({ orders }: ExportPDFButtonProps) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      doc.text("Business Report - Orders Summary", pageWidth / 2, 30, { align: "center" });
      ...
      // Add new page for customer details
      doc.addPage();
